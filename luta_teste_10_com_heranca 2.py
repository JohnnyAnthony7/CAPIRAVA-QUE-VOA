class Pessoa():
    def __init__(self,nome='pessoa generica',vida_max=100):
    ...
    def tomar_dano(self,dano):
        ...
        if dano['tipo'] == 'fogo':
            ...
            if valor_dano < 0:
               valor_dano = 0
        dano = dano.copy()
        dano['valor'] = valor_dano
        super().tomar_dano(dano)

class Lutador(Pessoa):

    def __init__(self,nome='lutador generico',vida_max=150):
        super().__init__(nome,vida_max)
        self.arma = 'espada'
...
class Barbaro(Pessoa):
    ...
    def __init__(self,nome='barbaro generico',vida_max=200):
        super().__init__(nome,vida_max)
        self.arma = 'espada'
...
class TesteLutas(unittest.TestCase):   
    ...
    def test_08_barbaro_sem_dano_contra_mago(self):
       merlin = Mago('merlin',120)
       conan = Barbaro('conan',200)
